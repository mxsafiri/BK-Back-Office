    ...
    <>
      ...
      <Card className="overflow-hidden">
        <div className="flex items-center justify-between border-b border-hairline px-5 py-4">
          <h2 className="font-heading text-base font-semibold text-ink">Open breaks · daily run 06:00</h2>
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {BREAKS.map((b) => {
              ...
              return (
                <tr key={b.account} className="border-b border-hairline last:border-0">
